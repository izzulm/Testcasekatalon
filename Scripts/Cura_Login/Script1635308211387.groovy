...
WebUI.setText(findTestObject('Object Repository/Cura_Test01/Page_CURA Healthcare Service/input_Username_username'), Username)

WebUI.setText(findTestObject('Object Repository/Cura_Test01/Page_CURA Healthcare Service/input_Password_password'), Password)
