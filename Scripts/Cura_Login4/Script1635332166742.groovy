...
WebUI.setText(findTestObject('Object Repository/Cura_Test01/Page_CURA Healthcare Service/input_Username_username'), 'admin')

WebUI.setText(findTestObject('Object Repository/Cura_Test01/Page_CURA Healthcare Service/input_Password_password'), 'admin')

WebUI.click(findTestObject('Object Repository/Cura_Test01/Page_CURA Healthcare Service/button_Login'))

WebUI.waitForElementPresent(findTestObject('Cura_Test01/Page_CURA Healthcare Service/Page_CURA Healthcare Service/p_Login failed Please ensure the username and password are valid'), 
    10)
